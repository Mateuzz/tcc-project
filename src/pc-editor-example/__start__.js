            ...
            setTimeout(function () {
                ...
                app.on("update", () => {
                    if (first) {
                        first = false;
                        window.defaultClock.end();
                        console.log(window.defaultClock.times);
                        app.root.findComponents("light").forEach(light => light.isStatic = true);
                    }
                })

                window.defaultClock.begin("sceneLoadingTime");
